{
  "name": "Child Home Visit cancellation",
  "uuid": "29df0a40-59f6-4ef7-853d-7a378655c170",
  "formType": "ProgramEncounterCancellation",
  "formElementGroups": [
    {
      "uuid": "03cd713d-a14d-4821-8181-1157e7ec6234",
      "name": "Details",
      "displayOrder": 1,
      "formElements": [
        {
          "name": "Cancel reason",
          "uuid": "370edc34-a9a9-4ce3-bf08-26c3b6f0b2a4",
          "keyValues": [
            {
              "key": "ExcludedAnswers",
              "value": [
        ...
        },
        {
          ...
          "uuid": "0bb083a3-d39d-483a-89c9-cb52ae102c75",
          "keyValues": [],
          "concept": {
            "name": "Other reason for cancelling the visit",
...
({params, imports}) => {
    ...
    const cancelReasonIsOther = new imports.rulesConfig.RuleCondition({programEncounter}).when.valueInCancelEncounter("f0a6eee8-3421-46cb-a500-309127e98231").containsAnswerConceptName("f169230d-809b-4d06-9ccb-96586977bb68").matches();
    ...
    if (currentlyActiveInProgram && qrtEncounter) {
        ...
        if ((takenToMedicalFacility || isSAMInLatestGMEncounter || !isGF1InLatestGMEncounter)  && cancelReasonIsOther  && !_.isNil(visitDate)) {
            scheduleBuilder.add({
